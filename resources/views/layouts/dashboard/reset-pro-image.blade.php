                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="dashboard-list-box margin-top-0">
                            <h4 class="gray">Change Profile</h4>
                            <div class="dashboard-list-box-static">

                                <!-- Avatar -->
                                <div class="edit-profile-photo">
                                    {!! Form::open (['url' => '/profile-image', 'method' => 'post', 'files'=>'true', 'enctype' => 'multipart/form-data']) !!}
                                    <img src="/uploads/{{$user->avater}}" alt="">

                                    <div class="change-photo-btn">
                                        <div class="photoUpload">
                                            <span><i class="fa fa-upload"></i> Upload Photo</span>
                                            <input class="upload" type="file" name="avater" value="{{$user->avater}}" required>
                                            <input class="search-field" type="hidden" value="{{$user->id}}" name="idd" />
                                ...
                                <input class="button margin-top-15" type="submit" value="Save Photo">
                            {!! Form::close () !!}
                            <!-- Details -->
