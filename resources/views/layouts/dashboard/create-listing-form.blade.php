    ...
    <div id="dashboard">
        ...
        <div class="dashboard-content">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="add-listing">
<h1 style="text-align: center;color: red"><a href="{{url('/my-list/'.Auth::User()->name)}}">{{Session::get('message')}}</a></h1>
{!! Form::open (['url' => '/list', 'method' => 'post', 'files'=>'true', 'enctype' => 'multipart/form-data']) !!}
    <!-- Section -->
    <div class="add-listing-section">
        ...
        <div class="row with-forms">
            <div class="col-md-12">
                ...
                <input class="search-field" type="text" value="" name="title" placeholder="Title" required/>
            </div>
        </div>
        ...
        <div class="row with-forms">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="keywords" placeholder="Keywords should be separated by commas" required>
            </div>
    ...
    <div class="add-listing-section margin-top-45">
        ...
        <!-- Dropzone -->
        <div class="submit-section">
            <input class="dropzone" type="file" name="upload_file" value="upload_file" required>
        </div>
    ...
    <div class="add-listing-section margin-top-45">
        ...
        <div class="row with-forms">
            ...
            <div class="col-md-4">
                ...
                <input type="text" placeholder="https://www.twitter.com/" name="twitr">
            </div>
    ...
    <div class="add-listing-section margin-top-45">
        ...
        <!-- Switcher ON-OFF Content -->
        @include('layouts.dashboard.pricing')
        <!-- Switcher ON-OFF Content / End -->
